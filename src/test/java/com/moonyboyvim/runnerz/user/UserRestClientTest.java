...
class UserRestClientTest {
    ...
    void shouldFindAllUsers() throws JsonProcessingException {
        ...
        User user1 = new User(
                ...
                "Bret",
                "Sincere@april.biz",
                new Address("Kulas Light", "Apt. 556", "Gwenborough",
    ...
    void shouldFindUserById() throws JsonProcessingException {
        ...
        assertEquals(user.name(), "Leanne Graham", "User name should be Leanne Graham!");
        assertEquals(user.username(), "Bret", "User name should be Bret!");
        ...
        assertAll("Address",
                ...
                () -> assertEquals(user.address().geo().lon(), "81.1496"),
